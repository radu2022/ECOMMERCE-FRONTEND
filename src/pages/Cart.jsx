    ...
    <div className="bg-gray-50">
      <div className="container mx-auto py-8 min-h-96 px-4 md:px-16 lg:px-24">
          ...
          <div className="p-2">
            ...
            <div className="flex flex-col lg:flex-row gap-8">
              ...
              <div className="lg:w-2/3">
                <div className="border border-teal-100 bg-gray-5 rounded-lg shadow-sm sticky p-2 md:p-2 mb-4 overflow-x-auto">
              ...
              <div className="border border-teal-100 lg:w-1/3 bg-gray-5 p-6 rounded-lg shadow-sm sticky top-8 h-fit">
                ...
                <div className="flex justify-between font-bold text-lg mb-2">
                  ...
                  <span className="text-xl font-bold text-teal-600">
                    ${cart.totalPrice?.toFixed(2) || totalPrice}
                  </span>
                </div>
                <Link to="/checkout">
                  <Button
        ...
        <div className="flex items-center pt-4 mt-4">
          <Link to="/shop">
            <Button className="bg-teal-800 h-8">Continue Shopping</Button>
          </Link>
        </div>
      </div>
    </div>
