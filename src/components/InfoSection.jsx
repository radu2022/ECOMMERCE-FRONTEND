...
const InfoSection = () => {
    const infoItems = [
      {
        icon: <Truck className="text-3xl text-teal-500" />,
        title: "Free Shipping",
        description: "Get your orders delivered with no extra cost",
      },
      {
        icon: <Headset className="text-3xl  text-teal-500" />,
        title: "Supprt 24/7",
        description: "We are here to assist you anytime",
      },
      {
        icon: <HandCoins className="text-3xl text-teal-500" />,
        title: "100% Money Back",
        description: "Full refund if you are not satisfied",
      },
      {
        icon: <LockKeyhole className="text-3xl text-teal-500" />,
        title: "Payment Secure",
        description: "Your payment information is safe with us",
      },
      {
        icon: <Tag className="text-3xl text-teal-500" />,
        title: "Discount",
